# GitOps with Cloudflare WAF and OPA

A simple demonstration of GitOps principles using Terraform, GitHub Actions, and Open Policy Agent (OPA) to ensure Cloudflare WAF rules are always protecting against attack scores.
...
- **GitOps Workflow**: Automated validation and deployment via GitHub Actions
